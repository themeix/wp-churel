...
!(function (e, t) {
    ...
    return (
        ...
        function t(e) {
                ...
                d = function () {
                    ...
                    return new n(function (t) {
                        if (p && -1 === v.indexOf(p)) t(L);
                            ...
                            if (
                                (E.original.dispatchEvent(x("medium-zoom:open", { detail: { zoom: L } })),
                            ...
                            if (
                                ...
                                E.zoomed.addEventListener("transitionend", function e() {
                                    (z = !1), E.zoomed.removeEventListener("transitionend", e), E.original.dispatchEvent(x("medium-zoom:opened", { detail: { zoom: L } })), t(L);
                                }),
                    ...
                    return new n(function (t) {
                        !z && E.original
                            ? ((z = !0),
                              ...
                              E.template && ((E.template.style.transition = "opacity 150ms"), (E.template.style.opacity = 0)),
                              E.original.dispatchEvent(x("medium-zoom:close", { detail: { zoom: L } })),
                              E.zoomed.addEventListener("transitionend", function e() {
                                  E.original.classList.remove("medium-zoom-image--hidden"),
                                      ...
                                      E.original.dispatchEvent(x("medium-zoom:closed", { detail: { zoom: L } })),
                                      (E.original = null),
                                      (E.zoomed = null),
                                      (E.zoomedHd = null),
                                      (E.template = null),
            ...
            var a,
                l,
                w = ((a = b.background), (l = document.createElement("div")).classList.add("medium-zoom-overlay"), (l.style.background = a), l);
                ...
                detach: function () {
                    ...
                    return (
                        n.forEach(function (e) {
                            e.classList.remove("medium-zoom-image"), e.dispatchEvent(x("medium-zoom:detach", { detail: { zoom: L } }));
                        }),
