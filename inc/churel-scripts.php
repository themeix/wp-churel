...
function churel_scripts()
{
    ...
    wp_enqueue_style('churel-main', CHUREL_CSS_URL . '/main.min.css', array(), rand(1, 455), 'all');
    ...
    wp_enqueue_script('churel-medium-zoom', CHUREL_JS_URL . '/medium-zoom.min.js', array('jquery'), rand(1, 455), true);
