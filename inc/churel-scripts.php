...
function churel_scripts()
{
    ...
    if (get_theme_mod('aos_animation_css_toggle_setting', '1')) {
    ...
    if (get_theme_mod('prism_css_toggle_setting', '1')) {
        wp_enqueue_style('churel-prism', CHUREL_CSS_URL . '/prism.css', array(), rand(1, 455), 'all');
    }

    if (get_theme_mod('lightbox_css_toggle_setting', '0')) {
    ...
    if (get_theme_mod('custom_animation_css_toggle_setting', '1')) {
    ...
    if (get_theme_mod('popper_js_toggle_setting')) {
